/**
 * `@mauvezero/custom` — Mauve-only helpers for the azpipe suite.
 *
 * What lives here:
 ...
 *   pieces from `@mauvezero/azpipe` / `azpipe-releases` / `azpipe-utils`.
 ...
 * push it upstream into `@mauvezero/azpipe-utils`, `azpipe-tasks`, or
