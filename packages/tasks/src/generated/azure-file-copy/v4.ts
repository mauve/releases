/* eslint-disable */
// Auto-generated from AzureFileCopyV4/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection } from '../connections.js';

export interface AzureFileCopyV4Inputs {
  /**
   * Source
   *
   ...
   *
   * Provide the time in minutes after which SAS token for the container will expire. By default,
   * this token expires after 4 hours.
   *
   * @default 240
   *
   * Only meaningful when: `Destination = AzureBlob`
 ...
 *
 * [Learn more about this task](https://aka.ms/azurefilecopyreadme)
 *
 * @see https://docs.microsoft.com/azure/devops/pipelines/tasks/deploy/azure-file-copy
 *
 * @see https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/AzureFileCopyV4
 */
export function azureFileCopyV4(
  inputs: AzureFileCopyV4Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("AzureFileCopy@4", inputs as unknown as Record<string, unknown>, opts);
}
