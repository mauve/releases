/* eslint-disable */
// Auto-generated from AzureFileCopyV5/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection } from '../connections.js';

export interface AzureFileCopyV5Inputs {
  /**
   * Source
   *
 ...
 *
 * @see https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/AzureFileCopyV5
 */
export function azureFileCopyV5(
  inputs: AzureFileCopyV5Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("AzureFileCopy@5", inputs as unknown as Record<string, unknown>, opts);
}
