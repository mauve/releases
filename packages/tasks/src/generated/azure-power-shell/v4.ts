/* eslint-disable */
// Auto-generated from AzurePowerShellV4/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection } from '../connections.js';

export interface AzurePowerShellV4Inputs {
  /**
   * Azure Subscription
   *
   ...
   *
   * If this is true, this task will restrict the scope of context to current task only and the
   * context will not be available to other tasks in the pipeline when using private agent.
   *
   * @default false
   */
 ...
 *
 * @see https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/AzurePowerShellV4
 */
export function azurePowerShellV4(
  inputs: AzurePowerShellV4Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("AzurePowerShell@4", inputs as unknown as Record<string, unknown>, opts);
}
