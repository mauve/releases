/* eslint-disable */
// Auto-generated from DownloadBuildArtifactsV0/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';

export interface DownloadBuildArtifactsV0Inputs {
  /**
   ...
   *
   * Optional number of times to retry downloading a build artifact if the download based on
   * redirect fails. If your network does not allow following the redirect, you can set this to
 ...
 *
 * @see
 * https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/DownloadBuildArtifactsV0
 */
export function downloadBuildArtifactsV0(
  inputs: DownloadBuildArtifactsV0Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("DownloadBuildArtifacts@0", inputs as unknown as Record<string, unknown>, opts);
}
