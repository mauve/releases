/* eslint-disable */
// Auto-generated from AzureRmWebAppDeploymentV4/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection } from '../connections.js';

export interface AzureRmWebAppDeploymentV4Inputs {
  /**
   * Connection type
   *
 ...
 */
export function azureRmWebAppDeploymentV4(
  inputs: AzureRmWebAppDeploymentV4Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("AzureRmWebAppDeployment@4", inputs as unknown as Record<string, unknown>, opts);
}
