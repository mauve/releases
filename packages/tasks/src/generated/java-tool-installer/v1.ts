/* eslint-disable */
// Auto-generated from JavaToolInstallerV1/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection } from '../connections.js';

export interface JavaToolInstallerV1Inputs {
  /**
   * JDK version
   *
 ...
 * task](https://learn.microsoft.com/en-us/azure/devops/pipelines/tasks/reference/java-tool-installer-v1)
 * or [see the Java documentation](https://docs.oracle.com/java/)
 *
 * @see https://docs.microsoft.com/azure/devops/pipelines/tasks/tool/java-tool-installer
 *
 * @see
 * https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/JavaToolInstallerV1
 */
export function javaToolInstallerV1(
  inputs: JavaToolInstallerV1Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("JavaToolInstaller@1", inputs as unknown as Record<string, unknown>, opts);
}
