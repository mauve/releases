/* eslint-disable */
// Auto-generated from HelmDeployV0/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection, kubernetesConnection } from '../connections.js';

export interface HelmDeployV0Inputs {
  /**
   * Connection Type
   *
   ...
   * In group: commands
   */
  "command": "create" | "delete" | "expose" | "get" | "init" | "install" | "login" | "logout" | "ls" | "package" | "rollback" | "save" | "upgrade" | "uninstall";
  /**
   * Chart Type
   *
   ...
   *
   * Only meaningful when: `chartType == Name`
   *
   * In group: commands
   */
  "chartName"?: string;
   ...
   * install ./redis'.
   *
   * Only meaningful when: `chartType == FilePath || command == package`
   *
   * In group: commands
   */
  "chartPath"?: string;
   ...
   *
   * Only meaningful when: `command == save`
   *
   * In group: commands
   */
 ...
 *
 * @see https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/HelmDeployV0
 */
export function helmDeployV0(
  inputs: HelmDeployV0Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("HelmDeploy@0", inputs as unknown as Record<string, unknown>, opts);
}
