/* eslint-disable */
// Auto-generated from CacheBetaV1/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';

export interface CacheBetaV1Inputs {
  /**
   * Key
   *
 ...
 *
 * @see https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/CacheBetaV1
 */
export function cacheBetaV1(
  inputs: CacheBetaV1Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("CacheBeta@1", inputs as unknown as Record<string, unknown>, opts);
}
