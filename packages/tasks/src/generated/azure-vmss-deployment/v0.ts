/* eslint-disable */
// Auto-generated from AzureVmssDeploymentV0/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection } from '../connections.js';

export interface AzureVmssDeploymentV0Inputs {
  /**
   * Azure subscription
   *
 ...
 *
 * @see
 * https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/AzureVmssDeploymentV0
 */
export function azureVmssDeploymentV0(
  inputs: AzureVmssDeploymentV0Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("AzureVmssDeployment@0", inputs as unknown as Record<string, unknown>, opts);
}
