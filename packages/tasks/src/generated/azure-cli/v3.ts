/* eslint-disable */
// Auto-generated from AzureCLIV3/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection, WorkloadIdentityUserConnection } from '../connections.js';

export interface AzureCLIV3Inputs {
  /**
   * Connection Type
   *
   ...
   * @default azureRM
   */
  "connectionType": "azureRM" | "azureDevOps";
  /**
   ...
   *
   * Select an Azure DevOps service connection
   *
   * Only meaningful when: `connectionType = azureDevOps`
   */
  "azureDevOpsServiceConnection"?: WorkloadIdentityUserConnection;
  /**
   * Script Type
   *
  ...
  /**
   * Allow no Azure subscriptions
   *
   * If true, the task will not attempt to set a subscription context and will allow logins where
   * the identity has access to no subscriptions. You can also supply an all-zero SubscriptionID
   * (00000000-0000-0000-0000-000000000000) in the service connection to implicitly skip setting
 ...
 * task](http://github.com/microsoft/azure-pipelines-tasks/blob/master/Tasks/AzureCLIV3/Readme.md)
 ...
 *
 * @see https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/AzureCLIV3
 */
export function azureCLIV3(
  inputs: AzureCLIV3Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("AzureCLI@3", inputs as unknown as Record<string, unknown>, opts);
}
