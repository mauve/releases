/* eslint-disable */
// Auto-generated from JenkinsDownloadArtifactsV2/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection, JenkinsConnection } from '../connections.js';

export interface JenkinsDownloadArtifactsV2Inputs {
  /**
 ...
 *
 * @see
 * https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/JenkinsDownloadArtifactsV2
 */
export function jenkinsDownloadArtifactsV2(
  inputs: JenkinsDownloadArtifactsV2Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("JenkinsDownloadArtifacts@2", inputs as unknown as Record<string, unknown>, opts);
}
