/* eslint-disable */
// Auto-generated from GradleV4/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';

export interface GradleV4Inputs {
  /**
   * Gradle wrapper
   *
 ...
 *
 * @see https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/GradleV4
 */
export function gradleV4(
  inputs: GradleV4Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("Gradle@4", inputs as unknown as Record<string, unknown>, opts);
}
