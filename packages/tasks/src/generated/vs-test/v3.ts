/* eslint-disable */
// Auto-generated from VsTestV3/task.json. Do not edit by hand.
// Run `pnpm sync-tasks` to regenerate.

import { makeTask, type TaskStepOptions } from '../../runtime.js';
import type { AzureRMConnection } from '../connections.js';

export interface VSTestV3Inputs {
  /**
   ...
   * Studio version starting from VS2026 followed by VS2022, VS2019, VS2017 and VS2015 depending
   * on what is installed. Visual Studio 2013 is not supported. To run tests without needing
   * Visual Studio on the agent, use the 'Installed by tools installer' option. Be sure to
   * include the 'Visual Studio Test Platform Installer' task to acquire the test platform from
   * nuget.
   *
   * - `latest` — Latest
   ...
   * In group: executionOptions
   */
  "vsTestVersion"?: "latest" | "18.0" | "17.0" | "16.0" | "15.0" | "14.0" | "toolsInstaller";
  /**
   ...
   *
   * Use this option if you have a custom logger. To use, provide the logger name along with its
   * parameters in the following format: 'friendlyName;key1=value1;key2=value2;....'
   *
   * In group: reportingOptions
   */
   ...
   *
   * If this option is turned on, test results won't be published as part of this task. Use
   * Publish Test Results task instead
   *
   * @default false
   *
   * Only meaningful when: `runInParallel = false`
   *
   * In group: reportingOptions
   */
 ...
 *
 * @see https://github.com/microsoft/azure-pipelines-tasks/tree/master/Tasks/VsTestV3
 */
export function vSTestV3(
  inputs: VSTestV3Inputs,
  opts: TaskStepOptions = {},
): ReturnType<typeof makeTask> {
  return makeTask("VSTest@3", inputs as unknown as Record<string, unknown>, opts);
}
